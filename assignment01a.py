...
array3=['the house that Jack built.','the malt ','the rat,','the cat, ','the dog, ','the cow with the crumpled horn,','the maiden all forlorn,',
'the man all tatter\'d and torn,','the priest all shaven and shorn,','the cock that crow\'d in the morn,','the farmer sowing his corn,']
a='This is '
b='That kept '
c='That waked '
d='That married '
